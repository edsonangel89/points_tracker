    ...
    <header>
        <nav>
            ...
            <div class="nav-links-container-mobile-tablet">
                ...
                <a id="customer-link-mobile" class="nav-link" href="http://localhost/checker/info">Clientes</a>
                <a id="logout-link-mobile" class="nav-link" href="http://localhost/checker/api/sessions/logout?uid=<?php echo $user_id ?>"><span class="material-symbols-outlined">logout</span></a>
